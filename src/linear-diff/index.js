...
/**
 * Included and changed the version by Ed Sanders for further improvements and fixes.
 * Semantic cleanup now works with different representations, too.
 * A bug which would result in not all EQUALS edits to be retained was fixed.
 *
 * The following methods have been added:
 * - matchChar
 * - matchString
...
diff_match_patch.prototype.matchChar = function (char, regex) {
  return char.match(regex);
};

diff_match_patch.prototype.matchString = function (string, regex) {
...
diff_match_patch.prototype.diff_main = function(text1, text2, options) {
  var opt_checklines, opt_deadline, keepText;
...
diff_match_patch.prototype.diff_cleanupSemanticLossless = function(diffs) {
  ...
  function diff_cleanupSemanticScore_(one, two) {
    ...
    var char2 = two[0];
    var nonAlphaNumeric1 = this.matchChar(char1, diff_match_patch.nonAlphaNumericRegex_);
    var nonAlphaNumeric2 = this.matchChar(char2, diff_match_patch.nonAlphaNumericRegex_);
    var whitespace1 = nonAlphaNumeric1 &&
      this.matchChar(char1, diff_match_patch.whitespaceRegex_);
    var whitespace2 = nonAlphaNumeric2 &&
      this.matchChar(char2, diff_match_patch.whitespaceRegex_);
    var lineBreak1 = whitespace1 &&
      this.matchChar(char1, diff_match_patch.linebreakRegex_);
    var lineBreak2 = whitespace2 &&
      this.matchChar(char2, diff_match_patch.linebreakRegex_);
    var blankLine1 = lineBreak1 &&
      this.matchString(one, diff_match_patch.blanklineEndRegex_);
    var blankLine2 = lineBreak2 &&
      this.matchString(two, diff_match_patch.blanklineStartRegex_);
  ...
  diff_cleanupSemanticScore_ = diff_cleanupSemanticScore_.bind(this)
...
diff_match_patch.prototype.diff_cleanupMerge = function(diffs) {
  ...
  if (this.isEqualString(diffs[diffs.length - 1][1], this.getEmptyString())) {
    diffs.pop();  // Remove the dummy entry at the end.
  }
